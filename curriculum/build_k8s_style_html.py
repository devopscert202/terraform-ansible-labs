#!/usr/bin/env python3
"""Regenerate the ansible/ HTML guides in k8sforbeginners style.

Ansible only. The Terraform track was moved out in Aug 2026: its pages are generated by
curriculum/gen_terraform_html.py and curriculum/gen_aws_primer.py on the shared shell in
curriculum/tf_style.py, and they live at one flat depth under terraform/html/.

The repo-root index.html is hand-maintained and is deliberately not written here.
"""
...
def main() -> None:
    ...
    # The repo-root index.html is hand-maintained; nothing here writes it.
