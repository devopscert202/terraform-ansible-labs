...
| VPC, subnet, gateway, route table, security group | `aws_vpc`, `aws_subnet`, `aws_internet_gateway`, `aws_route_table`, `aws_security_group` | [Lab 10 — Capstone](../../labmanuals/lab10-capstone-vpc-ec2.md) |

Lab 10 is the full build: the same network you clicked together here, declared in one root
