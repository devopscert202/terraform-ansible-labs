...
| **Time** | 40–50 minutes |
| **Tier** | Intermediate |
| **Files** | `terraform/labs/lab11-functions/` |
...
- [ ] Lab 10 completed ([lab10-collections.md](lab10-collections.md))
- [ ] You know what a list, a set, and a map are
- [ ] Working directory: `../labs/lab11-functions/` (no AWS credentials needed)
...
- Continue to [Lab 12 — Dynamic Blocks](lab12-dynamic-blocks.md)
