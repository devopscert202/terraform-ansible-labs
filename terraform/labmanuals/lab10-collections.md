...
| **Time** | 40–50 minutes |
| **Tier** | Intermediate |
| **Files** | `terraform/labs/lab10-collections/` |
...
- [ ] Lab 09 completed ([lab09-modules.md](lab09-modules.md))
...
- [ ] Working directory: `../labs/lab10-collections/` (no AWS credentials needed)
...
```bash
terraform plan -var 'subnets={app_a={cidr="10.0.1.0/24",az="us-east-1a"}}'
```
...
- Continue to [Lab 11 — Functions](lab11-functions.md)
