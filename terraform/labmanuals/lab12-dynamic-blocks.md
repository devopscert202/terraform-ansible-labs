...
| **Time** | 40–50 minutes |
| **Tier** | Intermediate |
| **Files** | `terraform/labs/lab12-dynamic-blocks/` |
...
- [ ] Lab 11 completed ([lab11-functions.md](lab11-functions.md))
...
- [ ] Working directory: `../labs/lab12-dynamic-blocks/`
- [ ] A default VPC exists in `us-east-1` — this security group has no `vpc_id`, so it needs one, for the reason given in [Lab 03](lab03-first-ec2.md):
...
```bash
cd terraform/labs/lab12-dynamic-blocks
cat variables.tf
```
...
- Deep dive: [docs/intermediate/08-modules.md](../docs/intermediate/08-modules.md)
- Visual: [html/intermediate.html](../html/intermediate.html)
- Continue to [Lab 13 — Multi-Provider](lab13-multi-provider.md)
