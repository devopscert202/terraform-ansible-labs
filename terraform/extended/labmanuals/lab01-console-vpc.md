...
> **Goal:** Reference only: identify VPC, subnet, route table, and security group relationships in the AWS console.
> **Time:** ~20 min · **Files:** `labs/lab01-console-vpc/`
...
- Run every command from `terraform/extended/labs/lab01-console-vpc`.
...
```bash
Open the AWS console and select a non-production region.
```
...
```bash
Do not create resources unless your training account permits it.
```
...
---
*Deep dive: [docs/projects/README.md](docs/projects/README.md). Next: [Lab 02](lab02-validate-only.md)*
