...
Deep dive for lab06 and lab07. Covers the three kinds of named value, the full precedence order
when the same variable is set twice, type constraints and validation, and how `sensitive` behaves
on an input.
...
**Visual summary:** [`../../html/intermediate.html`](../../html/intermediate.html)
...
|---|---|---|
| `string` | `"us-east-1"` | Double quotes |
...
Lab10 explores the difference between list, set, and map properly.
...
guarding state, covered in [`07-state.md`](07-state.md).
...
- Where variable values end up recorded, and why that is a secrets problem:
  [`07-state.md`](07-state.md)
- Passing variables into a reusable child module: [`08-modules.md`](08-modules.md)
- List, set, and map in depth: [`../advanced/functions.md`](../advanced/functions.md)
