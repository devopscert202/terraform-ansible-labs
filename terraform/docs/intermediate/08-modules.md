...
Deep dive for lab09. Covers what a module actually is, the boundary between root and child, how
values cross that boundary, how module resources are addressed in state, and when extracting a
module is worth it.
...
- Multiple providers and multi-stack repository layout:
  [`../advanced/projects.md`](../advanced/projects.md)
