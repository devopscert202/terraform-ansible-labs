...
Deep dive for lab08. Covers what state is for, what it contains — including secrets in plain text
— how refresh detects drift, and the inspection commands that mean you never have to open the file
by hand.
...
- Module addresses in state: [`08-modules.md`](08-modules.md)
- Moving state to S3 so a team can share it, with encryption and locking:
  [`../advanced/state.md`](../advanced/state.md)
