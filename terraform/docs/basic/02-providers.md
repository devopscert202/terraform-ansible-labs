...
Deep dive for lab01. Covers what a provider actually is, how `init` resolves one, what the lock
file protects you from, and the difference between a resource and a data source.
...
`us-east-1` provider everywhere until lab13, which is where multiple providers in one
...
- What resources and data sources do once you have a provider: [`03-resources.md`](03-resources.md)
...
| [Lab 03: First EC2 Instance](../../labmanuals/lab03-first-ec2.md) | The AWS provider and the AMI data source in action |
