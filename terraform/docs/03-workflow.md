...
Backs lab 04. Covers what each command in the loop actually guarantees, how to read plan output
symbol by symbol, when a saved plan matters, and when you must re-run `init`.
...
- The quality gates that belong in front of every `apply`: [`04-quality.md`](04-quality.md)
- What state is doing under all of this: [`06-state.md`](06-state.md)
